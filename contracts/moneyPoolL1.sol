...
contract moneyPoolL2 {
     ...
     */
    function addFundWithAction(address _tokenAddress, uint256 _tokenValue, string memory _data) external {
        addFund(_tokenAddress, _tokenValue);
        lockFundWithAction(_tokenAddress, _tokenValue, _data);
    }
