...
contract satisIDOWhitelist {
    ...
    uint256 startTime = 1646823600; // Unix timestamp in far far future
    uint256 endTime = 1646910000; // Unix timestamp in far far future
    //uint256 auctionTime = 86400;
