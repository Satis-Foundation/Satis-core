...
export interface MoneyPoolRawInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "workerDumpRebalancedFund",
    values: [AddressLike[], AddressLike, BigNumberish[], BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface MoneyPoolRaw extends BaseContract {
  ...
  queueCount: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  workerDumpRebalancedFund: TypedContractMethod<
    [
      _clientAddressList: AddressLike[],
      _tokenAddress: AddressLike,
      _queueValueList: BigNumberish[],
      _totalDumpAmount: BigNumberish
    ],
    [boolean],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "workerDumpRebalancedFund"
  ): TypedContractMethod<
    [
      _clientAddressList: AddressLike[],
      _tokenAddress: AddressLike,
