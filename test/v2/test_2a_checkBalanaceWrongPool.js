...
describe ("Check Money Pool balance (wrong pool)", function() {
    it ("Check balance value", async function() {
        ...
        await mainPool.connect(user0).addFund(tokenAddress,2000000,"2pool");
        console.log("Add fund done")
        var balanceValue = await mainPool.connect(user0).getClientBalance(user0['address'],tokenAddress,"1pool");
